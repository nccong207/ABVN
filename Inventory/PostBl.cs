...
namespace Inventory
{
    public class PostBl
    {
        ...
        public PostBl(Database dbData, string systableid, string timeCon, string condition)
        {
            ...
            mtpk = strucDb.GetValue("select Pk from systable where systableid=" + systableid).ToString();
        }
        public void Post()
        {
        ...
        {
            string s = "select bl.*, tb1.TableName as blTableName, tb2.TableName as mtTableName, tb3.TableName as dtTableName, tb3.Pk as dtpk " +
